...
"""Experiment C: turbine-specific Mutual-Information Graph Autoencoder for SCADA anomaly detection.

This version is intended to be run with --graph-method mi and includes
expanded per-Event and aggregate diagnostic figure generation.
